(function()
{
    return function()  
	{
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            var frame2 = new ChildFrame("frmTop",null,null,null,null,null,null,"frame::frmTop.xfdl",frame0);
            frame2.set_showtitleicon("false");
            frame2.set_showtitlebar("false");
            frame2.set_dragmovetype("none");
            frame0.addChild(frame2.name, frame2);
            frame2.set_formurl("frame::frmTop.xfdl");
            ...
            var frame4 = new ChildFrame("frmLeft",null,null,null,null,null,null,"frame::frmLeft.xfdl",frame3);
            frame4.set_showtitlebar("false");
            frame4.set_dragmovetype("none");
            frame4.set_showtitleicon("false");
            frame4.set_borderRadius("3px");
            frame3.addChild(frame4.name, frame4);
            frame4.set_formurl("frame::frmLeft.xfdl");


            var frame5 = new VFrameSet("vfrsWork",null,null,null,null,null,null,frame3);
            frame5.set_separatesize("*,0");
            frame5.set_showtitlebar("false");
            frame5.set_showtitleicon("false");
            frame5.set_border("1px none");
            frame3.addChild(frame5.name, frame5);

            var frame6 = new ChildFrame("frmMain",null,null,null,null,null,null,"frame::frmMain.xfdl",frame5);
            frame6.set_showtitlebar("false");
            frame6.set_dragmovetype("none");
            frame6.set_showtitleicon("false");
            frame6.set_borderRadius("3px");
            frame5.addChild(frame6.name, frame6);
            frame6.set_formurl("frame::frmMain.xfdl");


            var frame7 = new FrameSet("frmWork",null,null,null,null,null,null,frame5);
            frame7.set_showtitlebar("false");
            frame7.set_showtitleicon("false");
            frame5.addChild(frame7.name, frame7);

            var frame8 = new ChildFrame("frmMdi",null,null,null,null,null,null,"frame::frmMdi.xfdl",frame0);
            ...
            frame8.set_formurl("frame::frmMdi.xfdl");
        };
