(function()
{
	return function()
	{
            				...
            				[
            					{
            						"div_WF_Title" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #333451, 0px none")
            								}
            							}
            						}
            					}
            				...
            				[
            					{
            						"btn_LOGIN_Login" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #00B4D9"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("600 16px \"Malgun Gothic\"")
            								},
            								"disabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #00B4D9"),
            					...
            					},
            					{
            						"btn_LF_System" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#65615C"),
            									"font" : nexacro.FontObject("11px \"Malgun Gothic\",\"Arial\"")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            						...
            						"btn_LF_System_S" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("bold 11px \"Malgun Gothic\",\"Arial\"")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_WF_Inner" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #9899a7"),
            						...
            						"edi_LOGIN_Id" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 72px"),
            									"color" : nexacro.ColorObject("#222222"),
            									"font" : nexacro.FontObject("14px \"Malgun Gothic\"")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("1px solid #161940")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("1px solid #161940")
            					...
            					},
            					{
            						"sta_LF_MenuSetting" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px 80px 0px 10px"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("bold 11px \"Malgun Gothic\",\"Arial\"")
            								}
            							}
            					...
            					},
            					{
            						"sta_LOGIN_Title" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#333451"),
            									"font" : nexacro.FontObject("500 44px \"Malgun Gothic\""),
            					...
            					},
            					{
            						"sta_TF_Bg" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #05060e, 0px none")
            								}
            							}
            						}
            					},
            					{
            						"sta_WF_DetailLabelT" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #292B57, 1px solid #C1CFDF, 1px solid #C1CFDF, 1px solid #C1CFDF"),
            									"padding" : nexacro.PaddingObject("0px 8px"),
            									"wordWrap" : "char",
            									"color" : nexacro.ColorObject("#3F4168"),
            									"font" : nexacro.FontObject("600 12px/14px \"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					{
            						"sta_WF_DetailBgT" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #292B57, 1px solid #DFDFDF, 1px solid #DFDFDF, 1px solid #DFDFDF")
            								}
            							}
            						}
            					},
            					{
            						"sta_WF_DetailLabelB" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #C1CFDF, 1px solid #C1CFDF, 1px solid #BBBBBB, 1px solid #C1CFDF"),
            									"padding" : nexacro.PaddingObject("0px 8px"),
            									"wordWrap" : "char",
            									"color" : nexacro.ColorObject("#3F4168"),
            									"font" : nexacro.FontObject("600 12px/14px \"Malgun Gothic\"")
            					...
            					},
            					{
            						"sta_WF_DetailBgB" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #DFDFDF, 1px solid #DFDFDF, 1px solid #BBBBBB, 1px solid #DFDFDF")
            								}
            							}
            						}
            					},
        ...
        imgcache[nexacro._getImageLocation("theme://images/btn_WF_Calendar.png")] = { width:12, height:12 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/img_LOGIN_Id.png")] = { width:26, height:26 };
        		imgcache[nexacro._getImageLocation("theme://images/img_LOGIN_Pw.png")] = { width:26, height:26 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/loading.gif")] = { width:86, height:85 };
        		imgcache[nexacro._getImageLocation("theme://images/loadingFileUp.gif")] = { width:200, height:60 };
