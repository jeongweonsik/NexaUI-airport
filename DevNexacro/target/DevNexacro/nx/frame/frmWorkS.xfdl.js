(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divTitle","25","0",null,"47","0",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("div00");
            obj.set_formscrolltype("none");
            this.addChild(obj.name, obj);

            obj = new Static("staTitle","35","12",null,"26","90",null,null,null,null,null,this.divTitle.form);
            obj.set_taborder("1");
            obj.set_text("화면타이틀 (화면아이디)");
            obj.set_fittocontents("width");
            obj.set_wordWrap("none");
            obj.set_cssclass("sta_WF_HeaderTitle");
            this.divTitle.addChild(obj.name, obj);

            obj = new Div("divWork","20","divTitle:0",null,null,"20","20",null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("frmWorkS.xfdl", function() {
        /**
        * fraem work
        *@FileName  frmWork
        *@Creator 	{J}
        ...
        */
        ...
        this.loadIncludeScript("frmWorkS.xfdl");
